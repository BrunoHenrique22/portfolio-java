...
public class Cartas extends JDialog {
	 ...
	 */
	public Cartas() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Cartas.class.getResource("/Img/Deck.png")));
	...
	void sortearCarta() {
		...
		if (indiceFace == 10) {
			...
			lblNipeCentro.setIcon(new ImageIcon(Cartas.class.getResource("/img/Joker.png")));
